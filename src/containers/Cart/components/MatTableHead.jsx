...
const rows = [
  {
    id: 'name', disablePadding: true, label: 'Product Title',
  },
  {
    id: 'desired_qty', disablePadding: false, label: 'Desired QTY',
  },
  {
    id: 'available_qty', disablePadding: false, label: 'Available QTY',
  },
  {
  ...
  {
    id: 'delete_product', disablePadding: false, label: 'Del.',
  },
];
